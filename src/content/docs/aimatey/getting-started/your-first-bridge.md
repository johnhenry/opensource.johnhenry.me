...
### Dive Deeper
- **[IR Format Guide](/aimatey/guides/architecture/ir-format)** - Understand IR format
- **[Backend Package](/aimatey/packages/backend)** - All 24+ providers
...
- **[Testing](/aimatey/guides/testing)** - Test your AI code
...
- **[API Reference](/aimatey/api)** - Complete API docs
