...
- Completed [Tutorial 01: Simple Bridge](/aimatey/tutorials/beginner/simple-bridge)
...
**Continue learning:**
- [Tutorial 03: Multi-Provider Routing](/aimatey/tutorials/beginner/multi-provider) - Use multiple providers
- [Middleware Examples](https://github.com/johnhenry/aimatey/tree/main/packages/aimatey-docs/examples/03-middleware)
- [Middleware Package Docs](/aimatey/packages/middleware) - Complete middleware reference
...
**Ready for multi-provider routing?** Continue to [Tutorial 03: Multi-Provider Routing](/aimatey/tutorials/beginner/multi-provider)
